...
@Component({
  ...
  template: `
    <div class="w-56 xs:w-12 sm:w-52 md:w-60 lg:w-64 xl:w-72 2xl:w-80 h-full bg-sidebar-bg flex flex-col transform transition-all duration-300 ease-in-out shadow-xl xs:shadow-2xl">
      <!-- Logo Section -->
      <div class="p-3 xs:p-2 sm:p-4 md:p-5 lg:p-6 border-b border-gray-700">
        <div class="flex items-center space-x-2 xs:justify-center sm:space-x-3">
          <div class="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:w-8 md:w-10 md:h-10 lg:w-10 lg:w-10 xl:w-12 xl:w-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center flex-shrink-0 hover:scale-105 transition-transform duration-200">
            <svg class="w-3 h-3 xs:w-4 xs:h-4 sm:w-5 sm:w-5 md:w-6 md:h-6 lg:w-6 lg:w-6 xl:w-7 xl:w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"></path>
            </svg>
          </div>
          <div class="min-w-0 flex-1 xs:hidden sm:block">
          ...
          <ul class="space-y-1">
            <li *ngFor="let item of mainItems">
              <a 
                ...
                class="flex items-center xs:justify-center space-x-1 xs:space-x-0 sm:space-x-2 md:space-x-3 lg:space-x-3 px-2 xs:px-1 sm:px-2 md:px-3 lg:px-3 py-1.5 xs:py-2 sm:py-2 md:py-2.5 lg:py-2.5 rounded-lg transition-all duration-200 hover:scale-[1.02] xs:hover:scale-110"
